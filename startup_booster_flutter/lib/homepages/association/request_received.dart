...
class _RequestReceivedState extends State<RequestReceived> {
  ...
  Widget listView(list) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return widget.email != list.docs[index]['sender'] ? Container(
                                ...
                                child: IconButton(
                                    onPressed: () async {
                                      dataBaseMethods.acceptRequest(widget.type,
                                          ...
                                          email: list.docs[index]['email'].toString());
                                    },
  ...
  Widget build(BuildContext context) {
    return isLoading ? const Center(
          ...
          ) : StreamBuilder(stream: pendingRequestStream,
            builder: ((context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return checkLength ? listView(snapshot.data) : const Center(child: Text("No requests received"));
              } else {
                return Container();
              }}));
  }
