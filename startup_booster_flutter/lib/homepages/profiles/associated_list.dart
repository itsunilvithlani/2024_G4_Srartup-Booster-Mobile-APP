...
class _AssociatedListState extends State<AssociatedList> {
            ...
            child: Column(
              children: [
                Row(
                  children: [
                  /*  ClipOval(
                      child: widget.downloadUrls['${url}_photo'] == null ? const Icon(Icons.account_circle, size: 50) : Image.network(
                    ...
                    Column(
                      ...
                      children: [SizedBox(
                        ...
                        Text("₹${list.docs[index]['amount']}", style: const TextStyle(fontSize: 14.0, color: Colors.grey,),),
                      ],
                    ),
                  ],
                ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Associated ${widget.type == "investor" ? "startups" : "investors"}'),
