...
class _SelfProfileInvestorState extends State<SelfProfileInvestor> {
  ...
  Future pickImage(BuildContext context) async {
    try {
      ...
      if (!mounted) return;
      await dataBaseMethods.uploadLogo(context, image: _image, email: widget.email, type: "investors");
      await dataBaseMethods.getAllLogos("investors").then((value) {
        setState(() {
          downloadUrls = value;
          url = downloadUrls["${widget.email}_photo"] ?? "";
  ...
  Widget build(BuildContext context) {
    return isLoading ? Container(color: Colors.white, child: const Center(child: CircularProgressIndicator())) : Scaffold(
            appBar: AppBar(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: Row(children: [
                                  const Text("About", style: TextStyle(fontSize: 20.0,)),
                                  const SizedBox(width: 5.0),
                                  IconButton(
                                    onPressed: () {
                                      showDialogToEdit(0);
                                    },
                                    icon: const Icon(Icons.edit, size: 20.0, color: Color.fromARGB(255, 144, 141, 141)),
                                  ),
                                ],
                              )),
                        ),
                        ...
                        Padding(
                          ...
                          child: Align(
                              alignment: Alignment.centerLeft,
                              child: Text(searchListInvestor.about!,)
                          ),
                        ),
                        const SizedBox(height: 10.0),
                      ],
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(padding: const EdgeInsets.only(left: 30.0),
                          child: Row(
                            children: [
                              const Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("Investment Sector", style: TextStyle(fontSize: 20.0,))
                              ),
                              const SizedBox(width: 10.0),
                              IconButton(
                                onPressed: () {showDialogToEdit(1);}, icon: const Icon(Icons.edit, size: 20.0, color: Color.fromARGB(255, 144, 141, 141)),
                              ),
                            ],
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Align(
                              alignment: Alignment.centerLeft,
                              child: Text(searchListInvestor.investmentSector!, style: const TextStyle(fontSize: 14.0,))
                          ),
                        ),
                        const SizedBox(height: 10.0),
                      ],
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              const Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("Experience", style: TextStyle(fontSize: 20.0,))
                              ),
                              const SizedBox(width: 10.0),
                              IconButton(
                                onPressed: () {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(searchListInvestor.companytitle!, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                                    ),
                                    const SizedBox(height: 5.0),
                                    Padding(
                                      padding: const EdgeInsets.only(left: 20.0), child: Text(searchListInvestor.companyName!, style: const TextStyle(fontSize: 16),),
                                    ),
                                    const SizedBox(height: 5.0),
                                    Padding(
                                      padding: const EdgeInsets.only(left: 20.0),
                                      child: ReadMoreText("• ${searchListInvestor.aboutCompany!}",
                                        trimLines: 2,
                    ...
                    child: Column(
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Align(alignment: Alignment.centerLeft, child: Text("Email", style: TextStyle(fontSize: 14.0,))),
                        ),
                        const SizedBox(height: 5.0),
                        Padding(
                          padding: const EdgeInsets.only(left: 30.0),
                          child: Align(
                              alignment: Alignment.centerLeft, child: Text(searchListInvestor.email!, style: const TextStyle(color: Color.fromARGB(255, 117, 116, 116)),)
                          ),
                        ),
                        const SizedBox(height: 10.0),
                      ],
