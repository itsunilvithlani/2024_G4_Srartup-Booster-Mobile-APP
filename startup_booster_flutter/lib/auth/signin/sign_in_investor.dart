...
import 'package:startup_booster_flutter/auth/login/log_in_investor.dart';
import 'package:startup_booster_flutter/auth/signin/sign_in_investor2.dart';
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: InkWell(
                          ...
                          child: const Text("Next >", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16, color: Colors.blue),)),
                    ),
                  )
                ],
              ),
