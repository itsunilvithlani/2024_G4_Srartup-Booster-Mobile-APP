...
import 'package:startup_booster_flutter/auth/login/log_in_startup.dart';
import 'package:startup_booster_flutter/auth/signin/sign_in_startup2.dart';
      ...
      body: Stack(children: [
        ...
        Positioned.fill(
          ...
          child: Column(
            ...
            children: [
              const Text("Create new", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 28),
              ),
              const Text("Start-up account", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 28)),
              Row(
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const LogInStartUp()));
                      },
