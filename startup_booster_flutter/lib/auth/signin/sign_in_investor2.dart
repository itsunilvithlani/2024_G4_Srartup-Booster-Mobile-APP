              ...
              Positioned.fill(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    Text("Investor account",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 28)),
                  ],
                ),
              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Align(
                                alignment: Alignment.centerLeft,
                                child: Text("ABOUT YOUR COMPANY", style: TextStyle(color: Colors.grey),
                                )),
                          ),
                          Padding(
                            padding: const EdgeInsets.symmetric(
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                  value: selected,
                                  isExpanded: true,
                                  items: menuItem.map((e) => DropdownMenuItem<String>(value: e,
                                          child: Padding(
                                      ...
                                      AuthMethod.signupwithemailpassword(
                                        ...
                                        if (value != null) {
                                          databaseMethods.addInvestor({
                                            ...
                                            "token": '',
                                            "about": "Enter some information about you",
